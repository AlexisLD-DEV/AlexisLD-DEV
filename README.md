...
Je livre des interfaces React/TypeScript, des prototypes testables et des automatisations assistées par IA.

## Liens rapides

- Portfolio: [ledeunf.fr](https://ledeunf.fr/)
- CV PDF: [cv-alexis-le-deunf-2026-06-26.pdf](https://ledeunf.fr/cv-alexis-le-deunf-2026-06-26.pdf)
- Projets: [ledeunf.fr/projets/](https://ledeunf.fr/projets/)
- LinkedIn: [linkedin.com/in/ledeunf](https://www.linkedin.com/in/ledeunf/)

![Aperçu du portfolio Alexis Le Deunf](https://ledeunf.fr/og-image-2026-06-26.png)
...
- Backend / données: Supabase, Cloudflare Workers, D1, R2 selon les projets.
- Déploiement: Cloudflare Pages, Vercel, DNS, headers sécurité.
- IA et tooling: Codex CLI, GPT-5, Qwen, Ollama.
